...
public partial class ImageBrowserPage : Page
{
    ...
    protected void SelectImage(object sender, EventArgs e)
    {
        ...
        var img = new WebImage(FileImageFolder + ImageList.SelectedValue);
    ...
    protected void ResizeImage(object sender, EventArgs e)
    {
        ...
        img.Save(FileImageFolder + ImageList.SelectedValue);
    ...
    protected void Upload(object sender, EventArgs e)
    {
        if (IsImage(UploadedImageFile.FileName))
        {
            ...
            var img = new WebImage(UploadedImageFile.FileBytes);
            img.Resize(1024, 1024, true, true); //make 1024x1024 the largest image size
            img.Save(FileImageFolder + filename);
